...
\begin{proof}[Dimostrazione per \(\varphi , \mu\) misure finite]
    ...
    (E_{0})\), e quindi per definizione di derivata di Radon-Nikodym come \(\sup\) di \(\mathcal{F}\) che abbiamo dimostrato essere in \(\mathcal{F}\) possiamo assumere che \(\int_{E_{0}} \frac{\partial \varphi }{\partial
