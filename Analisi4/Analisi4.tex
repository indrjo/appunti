...
\begin{example}
    ...
    \frac{1}{q}}\). Vogliamo capire se c'è l'ugaglianza o meno. Per l'ugaglianza
    dobbiamo trovare un elemento \(0 \not\equiv f \in L^{p}{(\Omega)}\).
    Sia \(f = 1\), allora
    \begin{align*}
...
\[
\begin{cases}
    \varphi_0 (t) &= \displaystyle \frac{1}{\sqrt{2 \pi}} \\
    \varphi_{2k-1} (t) &= \displaystyle \frac{1}{\sqrt \pi} \sin(kt) \\
    \varphi_{2k}(t) &= \displaystyle \frac{1}{\sqrt \pi} \cos(kt)
\end{cases}
\]
