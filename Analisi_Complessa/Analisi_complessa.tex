...
estremi.
\begin{corollary}
    Sia \(f \in \mathcal{H}{(\Omega)}\), con \(\om\) semplicemente connesso. Allora \(f\) ammette primitiva in \(\Omega\)
\end{corollary}
\begin{remark}
...
\]
e poiché \(\left| \frac{\zeta -a}{z-a} = \frac{\rho_{1}}{z-a} \right| < 1 \)
...
\[
    = \sum_{m=-1}^{\infty} \underbrace{\left(\frac{1}{2 \pi i } \int_{\partial
...
\]
e come prima poiché \(\left| \frac{z -a}{\zeta -a} \le \frac{|z-a|}{\rho_{2}} <
1\right| \)  la precedente 
\[
